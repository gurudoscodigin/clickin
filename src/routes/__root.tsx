...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sites institucionais, softwares sob medida e automações. Sua empresa merece um clique de qualidade." },
      { property: "og:title", content: "ClickIn — desenvolvimento web, software e automação" },
      { property: "og:description", content: "Sites, softwares sob medida e automações. Sua empresa merece um clique de qualidade." },
